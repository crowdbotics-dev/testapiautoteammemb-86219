...
## Project Structure
    ...
    ├── testapiautoteammemb_86219  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_86219`
...
2. Clone this repo and `cd testapiautoteammemb_86219`
